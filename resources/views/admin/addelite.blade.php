...
@section('content')
							...
							<div class="tab-pane active" id="tab_0">
								...
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add Elite
										</div>
										<div class="tools">
	...
	<!-- BEGIN FORM-->
	<form action="{{ url('admin/addelite') }}" method="post" class="form-horizontal">
		{!! csrf_field() !!}
		<div class="form-body">
			...
			<label class="col-md-3 control-label">Adding Private Film Fees </label>
				<div class="col-md-4">
					<div class="input-group">
						<input type="number" value="0" name="film_fees" class="form-control input-circle-left" placeholder="Film Fees">
						<span class="input-group-addon input-circle-right">
