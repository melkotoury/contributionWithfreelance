...
@section('content')
			...
			<h3 class="page-title">
			Admins <small>reports & statistics</small>
			</h3>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Admin Table
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							...
							@if(count($user) > 0)
							@foreach($user as $us)
							<tr class="odd gradeX"  id="product{{$us->id}}"><th></th>
								<td>
									 {{ $us->fullname }}
								</td>
								<td>
								...
								<td class="center">
									 {{ $us->created_at->toDayDateTimeString() }}
								</td>
								<td class="text-center">
								<a href="{{ url('admin/edituser').'/'.$us->id }}" class="btn btn-sm yellow"> Edit <i class="fa fa-edit"></i></a>


						<button type="button" value="{{ $us->id }}"  class="btn btn-sm red delete-product"> Delete
