...
@section('content')
			...
			<!-- END PAGE HEADER-->
						...
						<!-- BEGIN FORM-->
						<form action="{{ url('admin/addprogrammer') }}" method="post" class="form-horizontal">
							{!! csrf_field() !!}
							<div class="form-body">
								...
								<div class="col-md-4">
									<div class="input-group">
										<select name="festival_id" class="form-control input-circle">
                                        	...
                                        	<option value="{{ $cat->id }}">{{ \App\User::find($cat->user_id)->fullname }}</option>
                                   			@endforeach
										</select>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="input-group">													
									<input type="text" name="fullname" class="form-control input-circle-left" placeholder="Enter text">
