...
<li>
<a type="button" class="dist_edit" data-content="{{ $name }}" data-id="{{ $id }}"><i class="fa fa-edit"></i> Edit</a>
</li>
<li>
<a href="" class="dist_delete" data-id="{{ $id }}"><i class="fa fa-remove"></i> Delete </a>
</li>
