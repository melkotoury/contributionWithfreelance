...
@section('header.scripts')
    ...
    <link href="{{ url('site') }}/css/vendors/select2.min.css" rel="stylesheet" />
...
<section id="main" class="margin-top-100">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal form-row-seperated" method="post" action="{{ url('festival/add_edition') }}" id="addEdition" enctype="multipart/form-data">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-film"></i>Create Edition </div>
                        </div>
                                    ...
                                    <div class="tab-pane active" id="tab_general">
                                                        ...
                                                        <div class="form-body">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                <input type="number" class="form-control" name="edition_number" placeholder="" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="edition_year" placeholder="" >
                                                            </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-new thumbnail" style="width: 300px; height: 150px;">
                                                            <img src="http://placehold.it/300x150?text=no image" alt="" /> </div>
                                                ...
                                                <div class="tab-pane " id="tab_awards">
                                                    ...
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                            <button type="submit" class="btn btn-primary" id="add_edition_submit"> Add Edition <i class="fa fa-plus-circle"></i> </button></form>
...
<script>
    ...
    $('#addEdition').ajaxForm({
        ...
        success: function(data) {
            ...
            $('#add_edition_submit').html('Add Edition');
